...
### 비즈니스 지표를 설계하고, 데이터 파이프라인으로 구현하는 Data Engineer
- 서비스와 비즈니스의 본질을 꼼꼼하게 파고들어 지표로 정의하고, End-to-End 데이터 파이프라인으로 현실화합니다.
- SLO 수립 · Event Taxonomy · Data Mart 설계부터 KPI 선정 및 대시보드 구축까지, 데이터 흐름의 처음과 끝을 직접 설계하고 구현합니다.
- 순간의 효율에 타협하지 않고, 책임감 있게 끝까지 파고들어 근본적인 문제를 해결합니다.
...
## Featured Projects
- [Bullet-in: 아스날 FC 이적 뉴스 서비스](https://github.com/benidjor/bullet-in)
